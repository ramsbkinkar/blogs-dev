...
def search():
    ...
    if query:
        # Search in titles, subtitles, and body content
...
def dashboard():
    ...
    user_comments = Comment.query.filter_by(author_id=current_user.id).all()
    total_likes = 0  # You can implement this if you have a likes system
